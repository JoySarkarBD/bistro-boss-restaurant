    ...
    <>
      <footer className='flex items-center justify-between w-full h-[350px]'>
        <div className='bg-neutral flex items-center flex-col justify-center text-white text-center w-1/2 h-full'>
          <h3 className=' text-base lg:text-2xl md:text-xl sm:text-base font-semibold'>
            CONTACT US
          </h3>
          <div className='space-y-2 mt-4 text-sm lg:text-lg md:text-base sm:text-sm'>
        ...
        <div className='bg-[#111827] flex items-center flex-col justify-center w-1/2 h-full text-white space-y-5'>
          ...
          <p className='text-sm lg:text-lg md:text-base sm:text-sm text-center'>
